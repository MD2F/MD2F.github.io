...
async function loadMarkdown() {
    ...
    // Pokud není žádné URL, načteme default.md
    if (!mdUrl) {
        mdUrl = 'res/md/default.md';
    }
    ...
    patterns.forEach(p => {
        ...
        if (p.pattern.startsWith('^(>+)')) {
            ...
            // Neuspořádané seznamy s vnořením
            ...
            // Obrázky s volitelným title a relativní cestou
            ...
            // Ostatní patterny (bold, italic, hr, code block, odkazy, headery)
